...
var dataFile = 'static/station data/data copy.tsv'

var margin2 = {top: 20, right: 200, bottom: 100, left: 50},
...
var yScale = d3.scale.linear()
    ...
    yScale2 = d3.scale.linear()  //second axis for bar chart
    .range([height, 0]);
...
console.log(data[0])
  ...
  var categories = color.domain().map(function(name) { // Nest the data into an array of objects with new keys
    ...
    return {
      ...
      visible: (name === "Precipitation" ? true : false) // "visible": all false except for economy which is true.
    };
  });
// console.log(data)
...
svg.append("bar")
    ...
    .enter().append("rect")
        ...
        .attr("yScale", function(d) { return yScale(d.Precipitation); })
        .attr("width", xScale.range())
        .attr("height", function(d) { return height - yScale(d.Precipitation); });
