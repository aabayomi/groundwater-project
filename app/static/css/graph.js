...
// d3.tsv("data copy.tsv", function(error, data) {
...
console.log(data[0])
  ...
  var categories = color.domain().map(function(name) { // Nest the data into an array of objects with new keys
    ...
    return {
      ...
      visible: (name === "Preci" ? true : false) // "visible": all false except for economy which is true.
    };
  });
// console.log(data)
...
svg.append("bar")
    ...
    .enter().append("rect")
        ...
        .attr("yScale", function(d) { return yScale(d.preci); })
        .attr("width", xScale.range())
        .attr("height", function(d) { return height - yScale(d.preci); });
